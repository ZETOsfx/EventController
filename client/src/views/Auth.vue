		  ...
		  <div class="content mt-5">
			...
			<div class="form-floating">
			  <div class="form-floating is-invalid">
				<input @keyup.enter="formNextFocus" v-model="username" type="text" class="form-control mb-2" name="name" id="floatingInputGroup" placeholder="Логин" style="color: black" required>
				<label for="floatingInputGroup" style="color: black">Логин</label>
			  </div>
			</div>
			<div class="form-floating is-invalid">
			  <input @keyup.enter="signIn" v-model="password" type="password" class="form-control mb-2" id="FIG" name="password" placeholder="Пароль" style="color: black" required>
...
export default {
	...
	methods: {
		formNextFocus() {
			...
			// Перехват отправки запроса на авторизацию
		async signIn() {
			this.submitted = true
