...
<template>
    <div class="intro">
        <div class="p-3 m-3 mt-0 pt-0" style="font-size: 150%">
            <h3 class="text p-0 mt-4" style="font-size: 150%">Важные объявления:</h3>
            <div class="row">
                <div v-for="ad in this.ads" class="col-lg-4 col-md-6 col-12 mb-3 mb-sm-0 g-3">
