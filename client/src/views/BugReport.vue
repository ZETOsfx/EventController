            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" @click="sendBug()" class="btn btn-success">Отправить баг-репорт</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <div class="row"> 
                    <div class="col-12 col-md-6">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <textarea class="form-control" @keyup.enter="send" v-model="this.description" placeholder="Подробное изложение ваших действий" id="ReportTextarea" style="height: 100px"></textarea>
                            </div>
                        </div>
...
export default {
    inject: ['getSession', 'browserName', 'browserVersion', 'osName', 'osVersion', 'browserEngineName', 'getSocket'],
    components: {
        toast
    },
    data() {
        return {
            ...
            description: '',
            timecode: '',
            author: this.getSession().public_name,
    ...
    methods: {
        ...
        async getTime() {  
            ...
            this.timecode = this.currentTime;
		},
        onLoad() {
            ...
            this.modalReportSend = new bootstrap.Modal(document.getElementById('ReportSend'));
        },
        send() {
        ...
        async sendBug() {
            if (this.short === '' || this.description === '') {
                this.errorMessage = 'Необходимо заполнить все поля для сообщения об ошибке.';
                this.errCallback.show();
                return;
            }

            await this.getTime();
            let response = await fetch('/note/sendreport', this.options('POST', { 
                short: this.short, 
            ...
            if (response.msg === 'succ') {
                this.successMessage = 'Сообщение об ошибке успешно отправлено.';
