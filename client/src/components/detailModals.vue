                        ...
                        <div class="tab-pane fade show active" id="pills-lesson" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.lesson !== '-'">
                                <div v-for="(event, index) in eventList.data.lesson" class="row gx-2 gy-2 align-items-center p-1">
                                    ...
                                    <div v-if="!editFormS[index].isDeleted && !editFormS[index].isDisabled && event.type === 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    ...
                                    <div v-if="!editFormS[index].isDeleted && !editFormS[index].isDisabled && event.type !== 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <div class="hstack gap-1">
                                            ...
                                            <button class="btn btn-outline-success" type="button" @click="openCanvas(eventList.data.lesson, index, types[event.type])">
                                ...
                                <div class="row gx-2 gy-2 align-items-center p-1">
                                    ...
                                    <div class="col-auto">
                                        <button @click="addEventCmp(editFormS, eventList.data.lesson)" type="submit" class="btn btn-success">Добавить</button>
                                    </div>
                        ...
                        <div class="tab-pane fade show" id="pills-break" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.breaktime !== 'lesson'">
                                <div v-for="(event, index) in eventList.data.breaktime" class="row gx-2 gy-2 align-items-center p-1">
                                    ...
                                    <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                    <div v-if="!editFormB[index].isDeleted && !editFormB[index].isDisabled && event.type === 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden" for="specificSizeInputGroupUsername1">Username</label>
                                        <input v-model="event.src" type="text" class="form-control" id="specificSizeInputGroupUsername1"
                                    ...
                                    <div v-if="!editFormB[index].isDeleted && !editFormB[index].isDisabled && event.type !== 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <div class="hstack gap-1">
                                            ...
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button" @click="openCanvas(eventList.data.breaktime, index, types[event.type])">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                    <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z"/>
                                                </svg>
                                            </button>
                            ...
                            <div v-if="eventList.data.breaktime !== 'lesson'" class="row gx-2 gy-2 align-items-center p-1">
                                ...
                                <div class="col-auto">
                                    <button @click="addEventCmp(editFormB, eventList.data.breaktime)" type="submit" class="btn btn-success">Добавить</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show" id="pills-dinner" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.lunch !== 'lesson' && eventList.data.lunch !== 'breaktime'">
                                <div v-for="(event, index) in eventList.data.lunch" class="row gx-2 gy-2 align-items-center p-1">
                                    ...
                                    <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                    <div v-if="!editFormL[index].isDeleted && !editFormL[index].isDisabled && event.type === 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden" for="specificSizeInputGroupUsername1">Username</label>
                                        <input v-model="event.src" type="text" class="form-control" id="specificSizeInputGroupUsername1"
                                    ...
                                    <div v-if="!editFormL[index].isDeleted && !editFormL[index].isDisabled && event.type !== 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <div class="hstack gap-1">
                                            <input class="form-control" type="text" :value="event.src.split('--')[1]" disabled>
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button" @click="openCanvas(eventList.data.lunch, index, types[event.type])">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                    <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z"/>
                                                </svg>
                                            </button>
                            ...
                            <!--ФОРМА ДОБАВЛЕНИЯ!!!!!!!!!-->
                            <div v-if="eventList.data.lunch !== 'lesson' && eventList.data.lunch !== 'breaktime'" class="row gx-2 gy-2 align-items-center p-1">
                                <div class="col-12 col-sm-4 col-md-4 col-lg-3">
                                    <label class="visually-hidden" for="specificSizeInputNameOfLol">Name</label>
                                    <input v-model="addForm.name" type="text" class="form-control" id="specificSizeInputNameOfLol" placeholder="Имя" required>
                                </div>
                                ...
                                <div class="col-auto">
                                    <button @click="addEventCmp(editFormL, eventList.data.lunch)" type="submit" class="btn btn-success">Добавить</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="eventList.data !== undefined" class="tab-content" id="pills-tabContent">
                        <div v-for="(template, index) in eventList.data" :class="'tab-pane fade show ' + (index === currentModalPage ? 'active' : '')" :id="'#pillsid-' + template.id" role="tabpanel" :tabindex="index">
                            <div v-for="(event, dex) in eventList.data[index].events" class="row gx-2 gy-2 align-items-center p-1">
                                ...
                                <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                <div v-if="!customForms[index][dex].isDeleted && !customForms[index][dex].isDisabled && event.type === 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    ...
                                    <input v-model="event.src" type="text" class="form-control" id="specificSizeInputGroupUsername135"
                                        placeholder="Ссылка" :disabled="customForms[index][dex].isDisabled">
                                </div>
                                ...
                                <div v-if="!customForms[index][dex].isDeleted && !customForms[index][dex].isDisabled && event.type !== 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    <div class="hstack gap-1">
                                        <input class="form-control" type="text" :value="event.src.split('--')[1]" disabled>
                                        <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                        <button class="btn btn-outline-success" type="button" @click="openCanvas(eventList.data[index].events, dex, types[event.type])">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z"/>
                                            </svg>
                                        </button>
                                ...
                                <div v-if="!customForms[index][dex].isDeleted" class="col-auto">
                                    ...
                                    <button @click="saveEventCmp(dex, customForms[index])" class="btn btn-secondary"> Сохранить </button>
                                ...
                                <div v-if="!customForms[index][dex].isDeleted && customForms[index][dex].isDisabled" class="col-auto">
                            ...
                            <div class="col-auto">
                                <button @click="addEventCmp(customForms[index], eventList.data[index].events)" type="submit" class="btn btn-success">Добавить</button>
                            </div>
                            </div>
