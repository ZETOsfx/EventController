<template>
    <!-- выборы файлов-->
    <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="Testoffc"
                ...
                <div v-for="file in filesClip">
                    <div class="card mb-2">
                        ...
                        <img src="https://i.ytimg.com/vi/MdTuact6xmY/maxresdefault.jpg"
                            style="object-fit: cover; width: 100%; height: 100%; max-height: 140px;">
                        <div class="card-body">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <!-- Пары -->
                            <button class="nav-link active" id="pills-lesson-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-lesson" type="button" role="tab" aria-selected="true">Пары</button>
                        </li>
                        <!-- Перерыв -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-break-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-break" type="button" role="tab"
                                aria-selected="false">Перерыв</button>
                        </li>
                        <!-- Обед -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-dinner-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-dinner" type="button" role="tab" aria-selected="false">Обед</button>
                        </li>
                    </ul>
                    ...
                    <div v-if="eventList.data" class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-lesson" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.lesson !== '-'">
                                <div v-for="(event, index) in eventList.data.lesson"
                                    ...
                                    <div v-if="!editFormS[index].isDeleted" class="col-12 col-sm-4 col-md-4 col-lg-3">
                                        ...
                                        <input v-model="event.name" type="text" class="form-control"
                                            id="specificSizeInputName1" placeholder="Имя"
                                            :disabled="editFormS[index].isDisabled">
                                    </div>

                                    <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                    <div v-if="!editFormS[index].isDeleted && !editFormS[index].isDisabled && event.type === 1"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden"
                                            for="specificSizeInputGroupUsername1">Username</label>
                                    ...
                                    <div v-if="!editFormS[index].isDeleted && !editFormS[index].isDisabled && event.type !== 1"
                                        ...
                                        <div class="hstack gap-1">
                                            <input class="form-control" type="text" :value="event.src.split('--')[1]"
                                                disabled>
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button"
                                                @click="openCanvas(eventList.data.lesson, index, types[event.type])">
                                            ...
                                            <button v-if="event.src.split('--')[1]" @click="clearFile(event)" type="button"
                                    ...
                                    <div v-if="!editFormS[index].isDeleted && editFormS[index].isDisabled"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <a type="button" class="btn btn-outline-info w-100" :href="event.src"
                                            target="_blank" rel="noopener noreferrer"> Просмотр </a>
                                    </div>
                                    ...
                                    <div v-if="!editFormS[index].isDeleted" class="col-12 col-sm-2 col-md-2 col-lg-1">
                                        <label class="visually-hidden"
                                            for="specificSizeInputGroupUsername2">Username</label>
                                    ...
                                    <div v-if="!editFormS[index].isDeleted" class="col-auto">
                                        <button v-if="!editFormS[index].isDeleted && editFormS[index].isDisabled"
                                            @click="editEventCmp(index, editFormS)" class="btn btn-secondary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <template v-if="!editFormS[index].isDisabled">
                                            <button @click="saveEventCmp(index, editFormS)" class="btn btn-secondary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-sd-card" viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <button @click="delEventCmp(index, editFormS, eventList.data.lesson)"
                                    ...
                                    <div v-if="!editFormS[index].isDeleted && editFormS[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('up', index, eventList.data.lesson, editFormS)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-up"></i></button>
                                    </div>
                                    <div v-if="!editFormS[index].isDeleted && editFormS[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('down', index, eventList.data.lesson, editFormS)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-down"></i></button>
                                    </div>
                                </div>
                                <!--ФОРМА ДОБАВЛЕНИЯ!!!!!!!!!-->
                                <div class="row gx-2 gy-2 align-items-center p-1">
                                    ...
                                    <div v-if="addForm.type == 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden"
                                            for="specificSizeInputGroupUserDebi4">Username</label>
                                    ...
                                    <div v-if="addForm.type != 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <div class="hstack gap-1">
                                            <input id="InputFileLessonAddForm" class="form-control" type="text"
                                                :value="addForm.src.split('--')[1]" disabled>
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button"
                                                @click="openCanvas(addForm, -1, types[addForm.type], true)">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                    <path
                                                        d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z" />
                                            ...
                                            <button v-if="addForm.src.split('--')[1]" @click="clearFile(addForm)"
                                    ...
                                    <div class="col-auto">
                                        <button @click="addEventCmp(editFormS, eventList.data.lesson)" type="submit"
                        ...
                        <div class="tab-pane fade show" id="pills-break" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.breaktime !== 'lesson'">
                                <div v-for="(event, index) in eventList.data.breaktime"
                                    class="row gx-2 gy-2 align-items-center p-1">
                                    <!-- ИМЯ СОБЫТИЯ -->
                                    ...
                                    <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                    <div v-if="!editFormB[index].isDeleted && !editFormB[index].isDisabled && event.type === 1"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden"
                                            for="specificSizeInputGroupUsername1">Username</label>
                                        <input v-model="event.src" type="text" class="form-control"
                                    ...
                                    <div v-if="!editFormB[index].isDeleted && !editFormB[index].isDisabled && event.type !== 1"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <div class="hstack gap-1">
                                            <input id="InputFileBreaktime" class="form-control" type="text"
                                                :value="event.src.split('--')[1]" disabled>
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button"
                                                @click="openCanvas(eventList.data.breaktime, index, types[event.type])">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                    <path
                                                        d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z" />
                                    ...
                                    <!-- КОГДА МЫ НЕ РЕДАКТИРУЕМ - КНОПКА ПРОСМОТРА -->
                                    <div v-if="!editFormB[index].isDeleted && editFormB[index].isDisabled"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <a type="button" class="btn btn-outline-info w-100" :href="event.src"
                                            target="_blank" rel="noopener noreferrer"> Просмотр </a>
                                    </div>
                                    ...
                                    <div v-if="!editFormB[index].isDeleted" class="col-auto">
                                        <button v-if="!editFormB[index].isDeleted && editFormB[index].isDisabled"
                                            @click="editEventCmp(index, editFormB)" class="btn btn-secondary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                <path
                                                    d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z" />
                                        ...
                                        <template v-if="!editFormB[index].isDisabled">
                                            ...
                                            <button @click="delEventCmp(index, editFormB, eventList.data.breaktime)"
                                                class="btn btn-outline-danger ms-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <div v-if="!editFormB[index].isDeleted && editFormB[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('up', index, eventList.data.breaktime, editFormB)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-up"></i></button>
                                    </div>
                                    <div v-if="!editFormB[index].isDeleted && editFormB[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('down', index, eventList.data.breaktime, editFormB)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-down"></i></button>
                                    </div>
                                </div>
                            </div>
                            <!--ФОРМА ДОБАВЛЕНИЯ!!!!!!!!!-->
                            <div v-if="eventList.data.breaktime !== 'lesson'" class="row gx-2 gy-2 align-items-center p-1">
                                <div class="col-12 col-sm-4 col-md-4 col-lg-3">
                                    <label class="visually-hidden" for="specificSizeInputNameOfLol">Name</label>
                                    <input v-model="addForm.name" type="text" class="form-control"
                                        id="specificSizeInputNameOfLol" placeholder="Имя" required>
                                ...
                                <div v-if="addForm.type != 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    <div class="hstack gap-1">
                                        <input id="InputFileBreaktimeAddForm" class="form-control" type="text"
                                            :value="addForm.src.split('--')[1]" disabled>
                                        <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                        <button class="btn btn-outline-success" type="button"
                                            @click="openCanvas(addForm, -1, types[addForm.type], true)">
                                        ...
                                        <div v-if="addForm.src.split('--')[1]" class="vr"></div>
                                        <button v-if="addForm.src.split('--')[1]" @click="clearFile(addForm)" type="button"
                                            class="btn btn-outline-danger">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                <path
                                ...
                                <div class="col-auto">
                                    <button @click="addEventCmp(editFormB, eventList.data.breaktime)" type="submit"
                                        class="btn btn-success">Добавить</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show" id="pills-dinner" role="tabpanel" tabindex="0">
                            ...
                            <div v-if="eventList.data.lunch !== 'lesson' && eventList.data.lunch !== 'breaktime'">
                                <div v-for="(event, index) in eventList.data.lunch"
                                    class="row gx-2 gy-2 align-items-center p-1">
                                    <!-- ИМЯ СОБЫТИЯ -->
                                    ...
                                    <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                    <div v-if="!editFormL[index].isDeleted && !editFormL[index].isDisabled && event.type === 1"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <label class="visually-hidden"
                                            for="specificSizeInputGroupUsername1">Username</label>
                                        <input v-model="event.src" type="text" class="form-control"
                                    ...
                                    <div v-if="!editFormL[index].isDeleted && !editFormL[index].isDisabled && event.type !== 1"
                                        ...
                                        <div class="hstack gap-1">
                                            ...
                                            <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                            <button class="btn btn-outline-success" type="button"
                                                @click="openCanvas(eventList.data.lunch, index, types[event.type])">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                    <path
                                                        d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z" />
                                    ...
                                    <!-- КОГДА МЫ НЕ РЕДАКТИРУЕМ - КНОПКА ПРОСМОТРА -->
                                    <div v-if="!editFormL[index].isDeleted && editFormL[index].isDisabled"
                                        class="col-12 col-sm-3 col-md-3 col-lg-2">
                                        <a type="button" class="btn btn-outline-info w-100" :href="event.src"
                                            target="_blank" rel="noopener noreferrer"> Просмотр </a>
                                    </div>
                                    ...
                                    <div v-if="!editFormL[index].isDeleted" class="col-auto">
                                        <button v-if="!editFormL[index].isDeleted && editFormL[index].isDisabled"
                                            @click="editEventCmp(index, editFormL)" class="btn btn-secondary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                <path
                                                    d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z" />
                                        ...
                                        <template v-if="!editFormL[index].isDisabled">
                                            ...
                                            <button @click="delEventCmp(index, editFormL, eventList.data.lunch)"
                                                class="btn btn-outline-danger ms-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <div v-if="!editFormL[index].isDeleted && editFormL[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('up', index, eventList.data.lunch, editFormL)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-up"></i></button>
                                    </div>
                                    <div v-if="!editFormL[index].isDeleted && editFormL[index].isDisabled" class="col-auto">
                                        <button @click="moveEventCmp('down', index, eventList.data.lunch, editFormL)"
                                            class="btn btn-outline-warning"><i class="fa-solid fa-down"></i></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="eventList.data.lunch !== 'lesson' && eventList.data.lunch !== 'breaktime'"
                                ...
                                <div v-if="addForm.type != 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    <div class="hstack gap-1">
                                        <input class="form-control" type="text" :value="addForm.src.split('--')[1]"
                                            disabled>
                                        <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                        <button class="btn btn-outline-success" type="button"
                                            @click="openCanvas(addForm, -1, types[addForm.type], true)">
                                ...
                                <div class="col-auto">
                                    <button @click="addEventCmp(editFormL, eventList.data.lunch)" type="submit"
                                        class="btn btn-success">Добавить</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button @click='templateSave()' type="button" class="btn btn-success"
                ...
                <div class="modal-body">
                    <ul v-if="eventList.data !== undefined" class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li v-for="(tmp, index) in eventList.data" class="nav-item" role="presentation">
                            <button @click="currentModalPage = index"
                                :class="'nav-link ' + (index === currentModalPage ? 'active' : '')" :id="'#id-' + tmp.id"
                                data-bs-toggle="pill" :data-bs-target="'#pillsid-' + tmp.id" type="button" role="tab"
                                :aria-selected="index === 0">{{ tmp.name }}</button>
                        </li>
                    </ul>

                    <div v-if="eventList.data !== undefined" class="tab-content" id="pills-tabContent">
                        <div v-for="(template, index) in eventList.data"
                            :class="'tab-pane fade show ' + (index === currentModalPage ? 'active' : '')"
                            :id="'#pillsid-' + template.id" role="tabpanel" :tabindex="index">
                            <div v-for="(event, dex) in eventList.data[index].events"
                                class="row gx-2 gy-2 align-items-center p-1">
                                <!-- ИМЯ СОБЫТИЯ -->
                                <div v-if="!customForms[index][dex].isDeleted" class="col-12 col-sm-4 col-md-4 col-lg-3">
                                    ...
                                    <input v-model="event.name" type="text" class="form-control"
                                        id="specificSizeInputName132" placeholder="Имя"
                                        :disabled="customForms[index][dex].isDisabled">
                                </div>

                                <!-- ПРИ РЕДАКТИРОВАНИИ ЕСЛИ ФОРМА - ТО ВСТАВЛЯЕМ ССЫЛКУ -->
                                <div v-if="!customForms[index][dex].isDeleted && !customForms[index][dex].isDisabled && event.type === 1"
                                    class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    <label class="visually-hidden" for="specificSizeInputGroupUsername135">Username</label>
                                    <input v-model="event.src" type="text" class="form-control"
                                        id="specificSizeInputGroupUsername135" placeholder="Ссылка"
                                        :disabled="customForms[index][dex].isDisabled">
                                </div>
                                ...
                                <div v-if="!customForms[index][dex].isDeleted && !customForms[index][dex].isDisabled && event.type !== 1"
                                    ...
                                    <div class="hstack gap-1">
                                        ...
                                        <!-- ВОТ ТУТ КНОПКА ВЫБОРА - ОТКРЫТИЯ OFFCANVAS (Сам он выше, на 2 строчке) -->
                                        <button class="btn btn-outline-success" type="button"
                                            @click="openCanvas(eventList.data[index].events, dex, types[event.type])">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
                                                <path
                                                    d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z" />
                                ...
                                <!-- КОГДА МЫ НЕ РЕДАКТИРУЕМ - КНОПКА ПРОСМОТРА -->
                                <div v-if="!customForms[index][dex].isDeleted && customForms[index][dex].isDisabled"
                                    class="col-12 col-sm-3 col-md-3 col-lg-2">
                                ...
                                <div v-if="!customForms[index][dex].isDeleted" class="col-12 col-sm-2 col-md-2 col-lg-1">
                                    <label class="visually-hidden"
                                        for="specificSizeInputGroupUsername88005553535">Username</label>
                                    <input v-model="event.time" type="number" class="form-control"
                                        id="specificSizeInputGroupUsername88005553535" placeholder="Время в сек"
                                        :disabled="customForms[index][dex].isDisabled">
                                </div>

                                <div v-if="!customForms[index][dex].isDeleted" class="col-auto">
                                    <button v-if="!customForms[index][dex].isDeleted && customForms[index][dex].isDisabled"
                                        @click="editEventCmp(dex, customForms[index])" class="btn btn-secondary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <template v-if="!customForms[index][dex].isDisabled">
                                        <button @click="saveEventCmp(dex, customForms[index])" class="btn btn-secondary">
                                            Сохранить </button>
                                        <button @click="delEventCmp(dex, customForms[index], eventList.data[index].events)"
                                            class="btn btn-outline-danger ms-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                <path
                                ...
                                <div v-if="!customForms[index][dex].isDeleted && customForms[index][dex].isDisabled"
                                    class="col-auto">
                                    <button
                                        @click="moveEventCmp('up', dex, eventList.data[index].events, customForms[index])"
                                        class="btn btn-outline-warning"><i class="fa-solid fa-up"></i></button>
                                </div>
                                <div v-if="!customForms[index][dex].isDeleted && customForms[index][dex].isDisabled"
                                    class="col-auto">
                                    <button
                                        @click="moveEventCmp('down', dex, eventList.data[index].events, customForms[index])"
                                        class="btn btn-outline-warning"><i class="fa-solid fa-down"></i></button>
                                </div>
                            </div>
                            ...
                            <div class="row gx-2 gy-2 align-items-center p-1">
                                <div class="col-12 col-sm-4 col-md-4 col-lg-3">
                                    ...
                                    <input v-model="addForm.name" type="text" class="form-control"
                                        id="specificSizeInputNameOfAkatsuki" placeholder="Имя" required>
                                </div>
                                ...
                                <div v-if="addForm.type == 1" class="col-12 col-sm-3 col-md-3 col-lg-2">
                                    ...
                                    <input v-model="addForm.src" type="text" class="form-control"
                                        id="specificSizeInputGroupUSA" placeholder="Ссылка" required>
                                </div>
                                ...
                                <div class="col-12 col-sm-2 col-md-2 col-lg-1">
                                    ...
                                    <input v-model="addForm.time" type="number" class="form-control"
                                        id="specificSizeInputGroupUserAss" placeholder="Время в сек" required>
                                </div>

                                <div class="col-auto">
                                    <button @click="addEventCmp(customForms[index], eventList.data[index].events)"
                                        type="submit" class="btn btn-success">Добавить</button>
                                </div>
                            </div>
...
export default {
    props: ['eventList', 'editFormS', 'editFormB', 'editFormL', 'addForm',
        'editEventCmp', 'addEventCmp', 'saveEventCmp', 'delEventCmp',
        'moveEventCmp', 'templateSave', 'currentModalPage', 'customForms'],
    data()
    {
        return {
